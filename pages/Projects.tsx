...
const Projects: React.FC = () => {
  ...
  useEffect(() => {
    const fetchAll = async () => {
      ...
      const [projectsRes, catsRes, settingsRes] = await Promise.all([
      ...
      if (settingsRes.data) {
        setSettings((prev) => ({ ...prev, showCategories: settingsRes.data.show_categories }));
      }
            ...
            {filteredProjects.map((p) => (
              ...
              >
                ...
                <div className="h-48 md:h-56 bg-gray-800 flex items-center justify-center border-b border-gray-700 relative overflow-hidden">
                  {p.imageUrl ? (
                    ...
                    <>
                      ...
                      <span className="absolute text-gray-500 font-bold uppercase tracking-widest text-[9px] bottom-3">
                        Photo en attente
                      </span>
                    </>
                  )}
                ...
                <div className="p-4 md:p-6 flex-grow flex flex-col justify-between">
                  <div>
                    <h3 className="text-lg md:text-xl font-bold text-white mb-1 md:mb-2 group-hover:text-voltcomRed transition-colors duration-300 uppercase leading-tight">
                      {p.title}
                    </h3>
